...
[![CI](https://github.com/PlatformStackPulse/tf-atom-kms-key-policy-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-kms-key-policy-aws/actions/workflows/ci.yml)
[![Latest Release](https://img.shields.io/github/v/release/PlatformStackPulse/tf-atom-kms-key-policy-aws)](https://github.com/PlatformStackPulse/tf-atom-kms-key-policy-aws/releases)
...
Terraform atom: AWS KMS Key Policy - attaches a resource policy to a KMS key
...
| <a name="input_policy"></a> [policy](#input\_policy) | JSON-encoded key policy document | `string` | n/a | yes |
